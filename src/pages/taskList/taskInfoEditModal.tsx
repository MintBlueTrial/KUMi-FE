...
export default class TaskEditModal extends React.Component<any, any> {
      ...
      >
        ...
        >
          <Form.Item
            ...
            initialValue={this.state.data.taskName}
          >
          ...
          <Form.Item
            ...
            initialValue={this.state.data.taskContent}
          >
            <TextArea
              showCount
              maxLength={200}
          ...
          <Form.Item
            ...
            initialValue={this.state.data.taskStatus}
          >
          ...
          <Form.Item
            ...
            initialValue={this.state.data.taskPrograss}
          >
